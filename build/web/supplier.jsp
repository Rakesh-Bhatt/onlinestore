<%-- 
    Document   : supplier1
    Created on : Aug 3, 2019, 7:56:44 PM
    Author     : CIT
--%>
...
<div class="col-lg-6">
    <div class="card">
        <div class="card-header">
            <strong>Add Supplier Form</strong>
        </div>
        <div class="card-body card-block">
            <form method="post" class="form-horizontal" action="AddSupplier" onsubmit="return validation()" name="addsupplier">

                <div class="row form-group">
                    <div class="col col-md-3"><label for="text-input" class=" form-control-label">Supplier Name</label></div>
                    <div class="col-12 col-md-9"><input type="text" id="text-input" name="sname" placeholder="Supplier name" class="form-control"></div>
                </div>
                <div class="row form-group">
                    <div class="col col-md-3"><label for="text-input" class=" form-control-label">Company Name</label></div>
                    <div class="col-12 col-md-9"><input type="text" id="text-input" name="cname" placeholder="Company name" class="form-control"></div>
                </div>
                <div class="row form-group">
